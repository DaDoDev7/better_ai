...
window.addEventListener('scroll', function() {
  ...
  var rotation = scrollPosition * 360 / (document.documentElement.scrollHeight - window.innerHeight);

  var scrollObject = document.querySelector('.football_img');
  scrollObject.style.transform = 'rotate(' + rotation + 'deg)';
});


//writing inside modal
